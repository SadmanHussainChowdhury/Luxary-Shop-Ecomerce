          ...
          <form onSubmit={onSubmit} className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <motion.button
                ...
                disabled={!!socialLoading || loading || success}
                whileHover={{ scale: socialLoading === 'google' ? 1 : 1.05 }}
                whileTap={{ scale: socialLoading === 'google' ? 1 : 0.95 }}
                className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-ocean-border rounded-lg hover:border-premium-gold transition font-medium text-ocean-darkGray disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {socialLoading === 'google' ? (
                  <div className="w-5 h-5 border-2 border-ocean-border border-t-premium-gold rounded-full animate-spin" />
                ) : (
              ...
              <motion.button
                ...
                disabled={!!socialLoading || loading || success}
                whileHover={{ scale: socialLoading === 'github' ? 1 : 1.05 }}
                whileTap={{ scale: socialLoading === 'github' ? 1 : 0.95 }}
                className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-ocean-border rounded-lg hover:border-premium-gold transition font-medium text-ocean-darkGray disabled:opacity-50 disabled:cursor-not-allowed"
              >
